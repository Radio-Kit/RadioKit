...
- The two state machines (0x55 widget + 0xAA FS) are fed from the same byte stream and demuxed by the start byte.
...
```
App -> Arduino: FS_LIST ("/")
  0xAA 0x01 0x05 0x00 0x01 0x2F

Arduino -> App: FS_LIST_DATA (2 entries)
  0xAA 0x81 0x14 0x00
  0x02 0x00
  0x01 0x00 0x00 0x00 0x00 0x04 'd' 'e' 'm' 'o'
  0x00 0x57 0x00 0x00 0x00 0x04 'R' 'E' 'A' 'D' 'M' 'E'
```
...
| v3.0 | Absolute Height/Width layout, META_UPDATE, enhanced reliability |
